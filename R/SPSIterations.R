## This is Derek Dapp's script for performing the SPS iterations in the Chinook TAMM.
...
#Set to your computer specific directory where your TAMMs are located
#Remember to use double slashes if copying/pasting

Dir <- "Desktop\\Old BP - Round 5\\Old BP\\TAMMs - SPS TEST\\"

for (i in 1992:2014){

  TAMM <- paste(Dir, "Valid2016_",i,"_OldBP_Round_5_8.15.2017.xlsm",sep="")
  ...
  MaxDiff <- 0
  for (i in 1:length(NextStepList)){

    Diff <- 1-(NextStepList[i]/CurrentStepList[i])
