...
# Set pa
Dir <- "C:\\Users\\dappdrd\\Desktop\\North of Falcon\\2024\\Model\\"
paths = list(paste(Dir, "Chin0024\\ChinRSScalarsMR24_3.7.2024.xlsm", sep=""),
             paste(Dir,"Chin0024\\2024 Pre-Season Chinook DB.mdb", sep =""))
